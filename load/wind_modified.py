...
_mfi modified by Mathew Owens (6/11/17) to include Bmag in the MAG data (this 
scalar quantity can differ from the vector sum of the components, particularly 
for longer time averages)
"""
import os
import pandas as pd
import numpy as np
